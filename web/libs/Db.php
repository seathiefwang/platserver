...
include_once __DIR__."/ezSQL-master/shared/ez_sql_core.php";
include_once __DIR__."/ezSQL-master/mysql/ez_sql_mysql.php";
/**********************************************************************
...
class Db
{
    ...
    public static $mysql_password     = "beeiot1017"; // 连接数据库用户名     
    public static $mysql_database     = "home"; // 连接数据库密码  
    public static $mysql_server_name  = "127.0.0.1"; // 数据库的名字    
